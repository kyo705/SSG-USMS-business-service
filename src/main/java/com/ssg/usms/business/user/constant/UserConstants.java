...
public class UserConstants {
    ...
    public static final String NOT_ALLOWED_ID_FORM_LITERAL = "아이디의 길이는 최소 5자 이상 최대 20자 이하, 특수문자가 포함되어서는 안됩니다.";
    ...
    public static final String ALREADY_EXISTS_ID_LITERAL = "이미 존재하는 아이디입니다.";
