...
public class IdentificationControllerTest {
    ...
    public void testSuccessSendVerificationCode() throws Exception {
        ...
        given(service.sendSms(any(),any())).willReturn(true);
    ...
    public void testBadGatewayException() throws Exception {
        ...
        given(service.sendSms(any(),any())).willThrow(new RuntimeException());
    ...
    public void testSuccessVerify() throws Exception {
        ...
        given(service.verifySms(any())).willReturn(requestdto);
    ...
    public void testFailedVerify() throws Exception {
        ...
        given(service.verifySms(any())).willThrow(new NotIdentificationException(INVALID_AUTHENTICATION_CODE_LITERAL));
